 ...
 * [redux-observable](https://github.com/redux-observable/redux-observable#documentation)
...
Realm.io provides a very fast database that is cross platform support.

Redux-Observable brings the RxJs advanced patterns for better handling of Side Effects.
