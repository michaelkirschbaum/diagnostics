/**
 * https://raw.githubusercontent.com/adhbh/rn-sprite/master/src/rnsprite.js
 */
...
export default class Sprite extends Component {
  ...
  componentWillMount () {
    if (this.props.iWidth && this.props.iHeight) {
      let width = this.props.iWidth;
      let height = this.props.iHeight;
      this.setState({
