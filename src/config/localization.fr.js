...
//    welcomeParagraph4: 'Guide rapide:',
  ...
  instructions: {
    ...
    ensurePairing: 'S\'assurer que le capteur est en mode appairage, avec la LED centrale clignotante puis passez à l\'écran suivant.',
  ...
  carInstallation: {
    ...
    enterRegion: 'Sélectionnez votre pays ici',
  ...
  home: {
    ...
    support: 'SOUTIEN',
    call: 'Votre demande a été prise en compte.  Votre assistant va prendre contact avec vous.',
  ...
  settings: {
    ...
    terms: 'Conditions générales d\'usage',
