...
module.exports = {
  ...
  brandInfo: colors.textSecondary,
  brandSuccess: colors.primary,
  brandDanger: colors.secondary,
  brandWarning: colors.secondary,
  brandSidebar: colors.backgroundSecondary,

  // Text
  inverseTextColor: colors.textPrimaryInverted,
  ...
  checkboxSize: 23,
  checkboxTickColor: colors.textPrimary,
  ...
  get inputColor () {
    return colors.textPrimaryInverted;
  },
  get inputColorPlaceholder () {
    return colors.textNavigation;
  },
