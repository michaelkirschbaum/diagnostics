...
//    welcomeParagraph4: 'We will go through a quick guide for the following steps:',
  ...
  device: {
    ...
    failure: 'There was a problem upgrading your PULS sensor. Please try again.',
    offline: 'Your support request has been received and will be forwarded when a network becomes available.'
  },
  carInstallation: {
